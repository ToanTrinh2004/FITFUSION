...
class UserInfoService {
  static const String _baseUrl = 'http://10.0.2.2:3000/api/PT/create';

  /// Create user info and send it to the backend API.
  static Future<bool> createCoachInfo(Coach coachInfo) async {
    try {
      ...
      final body = jsonEncode(coachInfo.toJson());
